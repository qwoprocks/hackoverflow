...
import {
  FlatList, StyleSheet, SafeAreaView, StatusBar, Text, Image,
  View, TouchableOpacity, Modal, Platform,
} from 'react-native';
...
import {
  StoreVoucher, UserVoucher, UserProfile, StoreProfile,
} from '../models';
  ...
  return (
    Platform.OS === 'web' ? (
      ...
      >
        ...
        <Dialog.Description>
          Do you want to purchase this item? You will be charged $$
          {(props.alertOptions.price / 100).toFixed(2)}
          .
        </Dialog.Description>
